# Awesome RT-Thread ![Awesome](https://awesome.re/badge.svg)
...
- [RunningMedian](https://github.com/RobTillaart/RunningMedian) - Arduino library to determine the running median by means of a circular buffer. `MIT`
- [TensorFlow-Lite-Micro](https://github.com/RTduino-libraries/TensorFlow-Lite-Micro) - TensorFlow Lite for Microcontrollers (TLFM) Library for RTduino. `Apache-2.0`
- [KalmanFilter](https://github.com/TKJElectronics/KalmanFilter) - Kalman Filter Arduino Library. `GPL-2.0`
- [TaskScheduler](https://github.com/arkhipenko/TaskScheduler) - Cooperative multitasking for Arduino. `BSD-3-Clause`
- [MsTimer2](https://github.com/RTduino-libraries/MsTimer2) - Run a function every millisecond for Arduino. `unknown`
- [Ticker](https://github.com/sstaub/Ticker) - Creating Tickers which can call repeating functions. Replaces delay() with non-blocking functions. `MIT`
